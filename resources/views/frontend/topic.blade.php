            ...
            <div class="lg:col-span-4 md:col-span-3 col-span-1">
                <div class="w-full bg-white rounded shadow-md">
                    <div class="w-full overflow-hidden">
                        <img src="{{ Storage::url($topic->image) }}" alt="{{ $topic->title }}" width="100%" height="auto">
                    </div>
                    <div class="px-5 pb-5">
                        <div class="my-3">
                            <h1 class="md:text-4xl text-xl font-bold"><strong>{{ $topic->title }}</strong></h1>
                            <p class="text-gray-600 mt-4">{{ $topic->description }}</p>
                        </div>
                        <hr>
                        <div class="my-3">
                            {{ $topic->body }}
                ...
                <livewire:frontend-comments :news="$topic"/>
            </div>
